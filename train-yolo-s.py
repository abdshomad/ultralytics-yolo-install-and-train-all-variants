#!/usr/bin/env python3
"""
Train YOLO26s model on chicken detection dataset.

Usage:
    uv run train-yolo-s.py [--epochs N] [--batch-size N] [--imgsz N] [--resume PATH] [--output-dir DIR]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train YOLO26s on chicken detection dataset",
