#!/usr/bin/env python3
"""
Train YOLO26l model on chicken detection dataset.

Usage:
    uv run train-yolo-l.py [--epochs N] [--batch-size N] [--imgsz N] [--resume PATH] [--output-dir DIR]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train YOLO26l on chicken detection dataset",
